...
| --- | --- | --- | --- | --- | --- |
| `getActiveTournaments` | GET | `api/competition/tournaments` | – | `competitionType` | – |
...
| `getLeaderboard` | GET | `api/competition/leaderboard/{competitionType}/{seasonType}` | `competitionType`, `seasonType` | `limit`, `offset` | – |
...
| `joinTournament` | POST | `api/competition/tournaments/{tournamentId}/join` | `tournamentId` | – | remaining args |
